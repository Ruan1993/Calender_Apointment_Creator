...
function renderHourlySchedule(dayKey, title) {
  ...
  const COLORS = [
    ...
    { bg: "bg-lime-200", border: "border-lime-500", text: "text-lime-900" },
    { bg: "bg-emerald-200", border: "border-emerald-500", text: "text-emerald-900" },
    { bg: "bg-cyan-200", border: "border-cyan-500", text: "text-cyan-900" },
    { bg: "bg-sky-200", border: "border-sky-500", text: "text-sky-900" },
    { bg: "bg-indigo-200", border: "border-indigo-500", text: "text-indigo-900" },
    { bg: "bg-violet-200", border: "border-violet-500", text: "text-violet-900" },
